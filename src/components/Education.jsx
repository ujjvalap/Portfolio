...
=======
    className="group border border-gray-700 hover:border-[#6a5acd] hover:shadow-[0_0_25px_#6a5acd] transition-all duration-300 p-6 rounded-2xl w-full sm:w-[320px] flex flex-col items-center cursor-pointer backdrop-blur-sm bg-white/5"
>>>>>>> old-history
  >
    <img
      src={image}
...
=======
    <div className="mt-12 rounded-3xl">
      {/* Header Section */}
      <div className={`rounded-t-3xl ${styles.padding} min-h-[250px]`}>
>>>>>>> old-history
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubText}>Education Details...</p>
          <h2 className={styles.sectionHeadText}>Education.</h2>
